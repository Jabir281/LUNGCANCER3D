...
def extract_luna16_data(data_root: str | Path, output_dir: str | Path):
    """
...
if __name__ == "__main__":
    ...
    extract_luna16_data(
        data_root=project_root / "luna16_processed",  # Folder with subset*.zip files
        output_dir=project_root / "data"              # Where to extract .npy files
    )
